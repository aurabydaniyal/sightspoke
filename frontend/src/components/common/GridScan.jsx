...
export const GridScan = ({
  ...
  // ✅ FIXED: Mouse interaction - Always works, even when webcam is disabled
  useEffect(() => {
    ...
    const onMove = e => {
      // ✅ REMOVED: if (uiFaceActive) return; - Always track mouse
      if (leaveTimer) {
    ...
    const onLeave = () => {
      // ✅ REMOVED: if (uiFaceActive) return; - Always reset on leave
  ...
  }, [snapBackDelay, scanOnClick, enableGyro]); // ✅ Removed uiFaceActive dependency
